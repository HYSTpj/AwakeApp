...
class _EventListPageState extends State<EventListPage> {
  ...
  void didUpdateWidget(EventListPage oldWidget) {
    ...
    // グループIDが変わった時だけ、既存のViewModelの中身を更新する
    if (oldWidget.groupId != widget.groupId) {
      setState(() {
        selectedEventId = null; // 選択状態を解除して一覧に戻す
        selectedEventTitle = null;
      });
      
      // ViewModelのインスタンスは変えず、groupIdだけ書き換えて再ロード
      // (EventListViewModelにupdateGroupIdメソッドを追加するか、以下のように処理)
