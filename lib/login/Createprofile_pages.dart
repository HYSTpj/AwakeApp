...
class CreateAccountBodys extends StatefulWidget {
  const CreateAccountBodys({super.key});

  @override
  State<CreateAccountBodys> createState() => _CreateAccountBodysState();
}

class _CreateAccountBodysState extends State<CreateAccountBodys> {
  // --- 機能を管理する変数 ---
